...
////// Emissive:
                ...
                float node_3641 = step(_lineTex_var.r,node_4134); // 阴影线
                float3 node_3161 = lerp(_dark.rgb,_light.rgb,node_3641);
                float3 node_6531 = (node_4134*_multiplycolor.rgb);
                float3 node_5752 = (node_3161+node_6531);
                float3 emissive = node_5752;
